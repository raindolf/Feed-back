...
$query = "INSERT INTO `feedback`(`customerId`,`fname`, `lname`, `email`, `mobile_number`, `product`,`branch`,`employee`, `feedback`, `suggestion`) VALUES('".$customerId."', '".$fname."', '".$lname."', '".$email."', '".$mobile."','".$product."', '".$branch."', '".$employee."', '".$feed."', '".$suggestion."')";
...
<!--                                         <div align="center"> -->
									    ...
									    foreach ($select_query_display as $select_query_display_value){
									        $selectTag .="<option name='pid' value='$select_query_display_value' >$select_query_display_value</option>";
									    }
									    }
...
<!--                                         <div align="center"> -->
									    ...
									    foreach ($select_query_display as $select_query_display_value){
									        $selectTag .="<option name='branch' value='$select_query_display_value' >$select_query_display_value</option>";
									    }
									    }
...
<!--                                         <div align="center"> -->
									    ...
									    foreach ($select_query_display as $select_query_display_value){
									        $selectTag .="<option name='employee' value='$select_query_display_value' >$select_query_display_value</option>";
									    }
									    }
                                    ...
                                    <p align="center"> <textarea name="feed" required></textarea></p>
                                    <label>
                                    <div align="center" class="style1">Any Suggestions</div>
                                    </label>
                                    <p align="center"><textarea name="suggestion" required></textarea></p>
                    ...
                    <div class="modal-footer">
                        <div align="center">
                          <input type="submit" value="Submit" name="feedback"  class="submit-button"/>
                            </div>
                   </div>
